...
import com.storemanager.controlers.DashboardController;
import com.storemanager.db.DBconnector;
import com.storemanager.auth.CurrentUser;
import com.storemanager.model.users.*;
import javafx.fxml.FXML;
...
public class LoginController {
    ...
    private boolean authenticateUser(String username, String password) {
        ...
        try (Connection connection = DBconnector.getConnection();
            ...
            if (resultSet.next()) {
                ...
                loadDashboard(role, username, password); // Pass credentials to dashboard
                return true;
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private void loadDashboard(String role, String username, String password) {
        try {
            FXMLLoader loader;
            Parent root;
            ...
            // Pass credentials to DashboardController
            DashboardController dashboardController = loader.getController();
            dashboardController.setLoginCredentials(username, password);
            System.out.println("Navigating to DashboardController with username: " + username);
